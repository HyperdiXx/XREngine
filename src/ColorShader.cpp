...
bool ColorShader::InitializeShader(ID3D11Device* device, HWND hWnd, WCHAR * hlslShader1, WCHAR * hlslShader2)
{
	...
	res = D3DCompileFromFile(L"../Engine/color.vs", NULL, NULL, "ColorVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
		&vertexShaderBuffer, &errorMessage);
	if (FAILED(res))
		return false;
	res = D3DCompileFromFile(L"../Engine/color.ps", NULL, NULL, "ColorPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
